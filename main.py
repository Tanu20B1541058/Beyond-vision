...
try:
    if uploaded_file is not None:
        ...
        X = df['Feature1'].values.reshape(-1, 1)  # Assuming 'Feature1' is your independent variable
        y = df['Target'].values  # Assuming 'Target' is your dependent variable
        ...
        with col9:
            ...
            feature_value = st.number_input("Enter Feature Value")
            predicted_value = model.predict([[feature_value]])[0]
